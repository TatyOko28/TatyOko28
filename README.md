...
<ul>
  ...
  <li>➕ Others: Best Practices to Improve SEO; Unit, integration and end-to-end (E2E) testing; CI/CD; Sentry for error tracking; WebSocket; WebHook, Celery and more </li>
</ul> <br/>
